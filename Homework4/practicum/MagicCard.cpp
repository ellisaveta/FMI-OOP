...
MagicCard::MagicCard(const std::string name, const std::string effect, const unsigned int& rarity, const CardType & type) : Card(name, effect, rarity), type(type) {}

MagicCard::MagicCard(const MagicCard & card) : Card(card.getName(), card.getEffect(), card.getRarity()), type(card.getType()) {}
